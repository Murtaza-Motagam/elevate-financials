        ...
        <div className="flex h-screen w-full">
            ...
            <div className="flex flex-col justify-center w-full md:w-1/2 px-6 md:px-16 py-10 text-center">
                <div className="max-w-md mx-auto">
                    <Image src='/images/logo.png' height={90} width={90} alt='logo' className='my-5 mx-auto' />
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                        Secure your access
                    </h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                        For your security, we’ve sent a 6-digit verification code to your registered mobile number.
                        Please enter the code below to continue to your secure banking dashboard.
                    </p>
