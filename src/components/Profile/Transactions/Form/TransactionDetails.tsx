    ...
    return (
        <LayoutModal open={open} setOpen={setOpen}>
            <div className="w-full flex flex-col gap-y-2">
                <h1 className='w-full text-center text-lg md:text-xl font-semibold border-b-2 border-gray-400 pb-2'>Transaction Details</h1>
                ...
                {transactionData.map((item) => (
                    ...
                    >
                        ...
                        {item.name === "Payment Status:" ? (
                            <p className={`font-bold uppercase flex items-center gap-x-1 text-right ${getStatusColor(item.data)}`}>
