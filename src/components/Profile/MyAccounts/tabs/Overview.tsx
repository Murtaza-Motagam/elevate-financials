...
const Overview = ({ accInfo }: AccountTabsProps) => {
  return (
    <div className='grid grid-cols-1 place-items-center md:grid-cols-3 gap-4 pl-3 md:pl-0'>
      <Card className='p-4 flex items-center w-full gap-3 bg-slate-100 dark:bg-slate-900'>
