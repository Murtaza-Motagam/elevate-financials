...
const DatePicker: React.FC<DatePickerProps> = ({ name, label, control, mandatory = false, placeholder = 'Pick a date', error }) => {
    const {
        ...
        <div>
            <Popover>
                <div className="flex flex-col mt-2">
                    <Label className="mb-2.5">{label}{mandatory && <span className='text-red-600 ml-1'>*</span>}</Label>
